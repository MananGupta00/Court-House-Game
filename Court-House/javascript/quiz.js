...
*/
    var quiz = [
        {
            "question"      :   "You must stand up for the jury members",
            "image"         :   "",
            "choices"       :   [
                                    "Stand",
                                ],
            "correct"       :   "Stand",
            "explanation"   :   "Excellent, pay your respects to the jury",
        },
        {"question"      :   "You must stand up for the jury members",
            "image"         :   "",
            "choices"       :   [
...
function fillQuizQuestions(QuesArr){
	quiz = QuesArr;
}
    ...
    jQuery(document).ready(function($){
        ...
        function processQuestion(choice){
			...
			if(currentquestion == quiz.length){
				...
				$('#submitbutton').html('Continue &raquo;').removeClass('btn-success').addClass('btn-warning').css({'font-weight':'bold', 'border-color':'#faa732', 'color':'#fff'}).on('click', async function(){
